...
import { u as useOptions, g as getKeyMapping, i as isSelectOptionGroup, a as getSelectValueArr, b as getSelectedOptions, O as Option } from '../../_chunks/dep-bc453549.js';
...
var Select = forwardRefWithStatics(function (originalProps, ref) {
  ...
  var onCheckAllChange = function onCheckAllChange(checkAll, e) {
    ...
    var _getSelectedOptions3 = getSelectedOptions(checkAllValue, multiple, valueType, keys, valueToOption),
      ...
      return function (_ref2) {
        ...
        return val.slice(0, minCollapsedNum ? minCollapsedNum : val.length).map(function (_, index) {
          var _getKeyMapping3 = getKeyMapping(keys),
            ...
            labelKey = _getKeyMapping3.labelKey,
            disabledKey = _getKeyMapping3.disabledKey;
