...
var getScrollbarWidth = require('../../_chunks/dep-449a2ae3.js');
var helper = require('../../_chunks/dep-ae12b99a.js');
...
var xorWith = require('../../_chunks/dep-e92cbf52.js');
...
function useFixed(props, finalColumns, affixRef) {
  ...
  var updateTableWidth = function updateTableWidth() {
    setTimeout(function () {
      var _tRef$getBoundingClie2, _tableElmRef$current;
      var tRef = tableContentRef.current;
      var rect = tRef === null || tRef === void 0 || (_tRef$getBoundingClie2 = tRef.getBoundingClientRect) === null || _tRef$getBoundingClie2 === void 0 ? void 0 : _tRef$getBoundingClie2.call(tRef);
      if (!rect) return;
  ...
  hooks_useDeepEffect["default"](updateFixedHeaderByUseDebounce, [maxHeight, data, columns, bordered, tableContentRef]);
  hooks_useDeepEffect["default"](function () {
