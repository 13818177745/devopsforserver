...
function getCascaderItemClass(prefix, node, SIZE, STATUS, cascaderContext) {
  ...
  return ["".concat(prefix, "-cascader__item")].concat(toConsumableArray._toConsumableArray(getNodeStatusClass(node, STATUS, cascaderContext)), [SIZE[size], defineProperty._defineProperty(defineProperty._defineProperty({}, "".concat(prefix, "-cascader__item--with-icon"), !!node.children), "".concat(prefix, "-cascader__item--leaf"), node.isLeaf())]);
}
