...
var get = require('./dep-4025eebb.js');
var isPlainObject = require('./dep-1ad3f489.js');
var isNumber = require('./dep-06fcd15c.js');
var isString = require('./dep-62033ccc.js');
...
var setValueToOptionFormOptionDom = function setValueToOptionFormOptionDom(dom, valueToOption, keys) {
  ...
  valueToOption[value] = _objectSpread$1(_objectSpread$1({}, dom.props), {}, defineProperty._defineProperty(defineProperty._defineProperty({}, valueKey, value), labelKey, label || children || value));
};
var getValueToOption = function getValueToOption(children, options, keys) {
    ...
    options.forEach(function (option) {
      if (isSelectOptionGroup(option)) {
        ...
        (_option$children = option.children) === null || _option$children === void 0 || _option$children.forEach(function (child) {
          valueToOption[get.get(child, valueKey)] = _objectSpread$1(_objectSpread$1({}, child), {}, {
            value: get.get(child, valueKey),
            label: get.get(child, labelKey)
          });
        });
      } else {
        valueToOption[get.get(option, valueKey)] = _objectSpread$1(_objectSpread$1({}, option), {}, {
  ...
  if (isPlainObject.isPlainObject(children)) {
    ...
    if (children.type === select_base_OptionGroup["default"]) {
      ...
      if (Array.isArray(groupChildren)) {
        groupChildren.some(function (item) {
          var selectedValue = isPlainObject.isPlainObject(value) ? get.get(value, "value") : value;
          if (isPlainObject.isPlainObject(item.props) && item.props.value === selectedValue) {
      ...
      if (item.type === select_base_OptionGroup["default"]) {
        ...
        if (Array.isArray(_groupChildren2)) {
          var isSelected = _groupChildren2.some(function (item2) {
            var selectedValue2 = isPlainObject.isPlainObject(value) ? get.get(value, "value") : value;
            if (isPlainObject.isPlainObject(item2.props) && item2.props.value === selectedValue2) {
  ...
  if (Array.isArray(values)) {
    ...
    if (selected) {
      currentValues = currentValues.filter(function (item) {
        if (isValueObj) {
          if (isPlainObject.isPlainObject(activeValue)) {
...
var Option = function Option(props) {
  ...
  return /* @__PURE__ */React__default["default"].createElement("li", {
    className: classNames__default["default"](className, "".concat(classPrefix, "-").concat(componentType, "-option"), defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty({}, "".concat(classPrefix, "-is-disabled"), disabled), "".concat(classPrefix, "-is-selected"), selected), "".concat(classPrefix, "-size-s"), size === "small"), "".concat(classPrefix, "-size-l"), size === "large")),
    key: value,
    ...
    setSelectedOptions(function (oldSelectedOptions) {
      var createOptionFromValue = function createOptionFromValue(item) {
        if (valueType === "value") {
          ...
          }) || defineProperty._defineProperty(defineProperty._defineProperty({}, valueKey, item), labelKey, item);
        }
...
//# sourceMappingURL=dep-56f8339e.js.map
